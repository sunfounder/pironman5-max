...
In this chapter, you will learn how to log in to the Raspberry Pi. This section will guide you through opening the terminal, which you will use in later chapters to enter commands.
